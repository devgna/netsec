...
$ docker run -d \
         ...
         -h netsec \
         -p 8000:8000 \
         -v /tmp/netsec:/opt/xml \
         reborntc/netsec

$ # now you can run Nmap and save the XML Report on /tmp/netsec
$ nmap -sT -A -T4 -oX /tmp/netsec/myscan.xml 192.168.1.0/24
```
...
```bash
$ docker exec -ti netsec /root/token
```

### Upgrade from previous release
```bash
$ # stop running netsec container
$ docker stop netsec

$ # remove netsec container
$ docker rm netsec

$ # pull new image from dockerhub
$ docker pull reborntc/netsec

$ # run WebMap
$ curl -sL http://bit.ly/netsecsetup | bash
```
